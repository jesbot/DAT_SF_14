...
\end{equation}
This is very straightforward activation function, illustrated in \figref{}, that tends to have more favorable characteristics from the perspective of backward propagation, which is the \textit{learning} process of the network.
\begin{figure}[htbp]
\begin{center}
...
\subfigure[Sigmoid Function]{\label{sig}\includegraphics[scale=0.45]{images/SigFunction.pdf}}
  \ \ \ \ 
\subfigure[ReLu Function]{\label{sig}\includegraphics[scale=0.45]{images/reLu.png}}
